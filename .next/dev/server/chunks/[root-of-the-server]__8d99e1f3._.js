...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/server.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$documents$2f$upload$2f$route$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/api/documents/upload/route.ts [app-route] (ecmascript)");
;
;
const runtime = 'nodejs';
const OS_KB = [
    ...
    for (const item of OS_KB){
        for (const keyword of item.keywords){
            if (q.includes(keyword.toLowerCase())) {
                return {
                    ...item,
                    source: 'Operating Systems Knowledge Base'
                };
            }
        }
    }
    ...
    for (const item of SOMATOSENSORY_KB){
        for (const keyword of item.keywords){
            if (q.includes(keyword.toLowerCase())) {
                return {
                    ...item,
                    source: 'Somatosensory System Knowledge Base'
                };
            }
        }
    }
...
async function POST(req) {
    try {
        ...
        try {
            const uploadedText = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$documents$2f$upload$2f$route$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getStoredText"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8d99e1f3._.js.map